...
###########################################
source(here::here("R", "AWSfunctions.R"))
source(here::here("R", "queryfunctions.R"))
...
######################################
  ...
  uk_balance_data <- reactive({
    ...
    returndata <- get_uk_balance_data(tradedata,
                                      tradetable = ttable,
...
######################################
  ...
  country_top_trade <- reactive({
    ...
    returndata <- get_country_top_trade(tradedata,
                                        tradetable = ttable,
                                        tradeyear = input$cyear,
                                        flowtype = input$cflow,
                                        country = input$country)
    returndata
  ...
  country_tot_trade <- reactive({
      ...
      returndata <- get_country_tot_trade(tradedata,
                                          tradetable = ttable,
                                          tradeyear = input$cyear,
                                          flowtype = input$cflow,
                                          commoditygroup = ccode,
...
``` {r drilldown_picker}
  ...
  clist <- get_commodity_list(tradedata,
                              tradetable = ttable,
                              flowtype = input$cflow,
                              commoditygroup = ccode,
                              country = input$country)
  ...
  chtdata <- get_country_commodity_data(tradedata,
                                        tradetable = "trademonthly",
                                        flowtype = input$cflow,
                                        commoditygroup = ccode,
                                        commodity = input$drilldownffd,
                                        country = input$country) 
